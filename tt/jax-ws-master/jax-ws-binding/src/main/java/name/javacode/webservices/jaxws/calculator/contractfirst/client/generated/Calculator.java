...
public interface Calculator {
     ...
     * @param parameters
     * @return
     *     returns name.javacode.webservices.jaxws.calculator.contractfirst.client.generated.AddResponse
     */
    @WebMethod
    ...
    @RequestWrapper(localName = "subtractDefaultWrapped", targetNamespace = "http://javacode.name/webservices/jaxws/calculator-cf/", className = "name.javacode.webservices.jaxws.calculator.contractfirst.client.generated.SubtractDefaultWrapped")
    @ResponseWrapper(localName = "subtractResponse", targetNamespace = "http://javacode.name/webservices/jaxws/calculator-cf/", className = "name.javacode.webservices.jaxws.calculator.contractfirst.client.generated.SubtractResponse")
