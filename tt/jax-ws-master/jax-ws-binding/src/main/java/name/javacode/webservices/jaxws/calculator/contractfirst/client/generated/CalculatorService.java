 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://javacode.name/webservices/jaxws/calculator-cf/", wsdlLocation = "http://localhost:8080/jax-ws-binding/calculator-cf?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://javacode.name/webservices/jaxws/calculator-cf/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jax-ws-binding/calculator-cf?wsdl");
    ...
    public Calculator getCalculator() {
        return super.getPort(new QName("http://javacode.name/webservices/jaxws/calculator-cf/", "Calculator"), Calculator.class);
    }
    ...
    public Calculator getCalculator(WebServiceFeature... features) {
        return super.getPort(new QName("http://javacode.name/webservices/jaxws/calculator-cf/", "Calculator"), Calculator.class, features);
    }
