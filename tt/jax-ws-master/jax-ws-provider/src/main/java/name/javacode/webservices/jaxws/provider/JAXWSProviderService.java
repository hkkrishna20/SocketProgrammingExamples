package name.javacode.webservices.jaxws.provider;
...
@WebServiceProvider(portName = "JAXWSProvider", serviceName = "JAXWSProviderService", targetNamespace = "http://javacode.name/webservices/jaxws/provider/")
...
public class JAXWSProviderService implements Provider<SOAPMessage> {
	...
	try {
	    ...
	    QName resultElementQName = new QName(
		    "http://javacode.name/webservices/jaxws/provider/",
		    "result", "ns");
