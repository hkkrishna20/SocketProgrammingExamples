...
import name.javacode.webservices.jaxws.handler.SOAPMessageLoggingHandler;
import name.javacode.webservices.jaxws.instrumentation.client.CalculatorClient;
 ...
 */
@ComponentScan(basePackages = "name.javacode.webservices.jaxws.instrumentation.config", excludeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = DispatcherConfig.class))
public class AppConfig {
	private static final String ENDPOINT_URL = "http://localhost:8080/jax-ws-instrumentation/CalculatorService";
	public static final String NAMESPACE_URI = "http://instrumentation.jaxws.webservices.javacode.name/";
