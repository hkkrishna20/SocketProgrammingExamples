package name.javacode.webservices.jaxws.security.sym;
...
import name.javacode.webservices.jaxws.security.sym.client.CalcResource;
import name.javacode.webservices.jaxws.security.sym.gen.CalculatorSymService;
...
public class CalcIT {
    private static final String CALCULATOR_SERVICE_NAME = "ws-security-symmetric-encryption";
	...
	WebArchive client = ShrinkWrap
		.create(WebArchive.class,
			"ws-security-symmetric-encryption-client.war")
		.addPackages(true, CalcResource.class.getPackage())
		.addPackages(true, CalculatorSymService.class.getPackage())
		.addAsResource(
	...
	root = this.client
		.target("http://localhost:8080/ws-security-symmetric-encryption-client");
    }
