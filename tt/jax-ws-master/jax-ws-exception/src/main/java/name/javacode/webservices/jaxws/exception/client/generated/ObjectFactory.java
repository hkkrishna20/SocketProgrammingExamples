...
package name.javacode.webservices.jaxws.exception.client.generated;
 ...
 * generated in the name.javacode.webservices.jaxws.exception.client.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _MultiplyResponse_QNAME = new QName("http://exception.jaxws.webservices.javacode.name/", "multiplyResponse");
    private final static QName _Multiply_QNAME = new QName("http://exception.jaxws.webservices.javacode.name/", "multiply");
    private final static QName _DivisionByZeroException_QNAME = new QName("http://exception.jaxws.webservices.javacode.name/", "DivisionByZeroException");
    private final static QName _DivideResponse_QNAME = new QName("http://exception.jaxws.webservices.javacode.name/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://exception.jaxws.webservices.javacode.name/", "divide");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: name.javacode.webservices.jaxws.exception.client.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exception.jaxws.webservices.javacode.name/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exception.jaxws.webservices.javacode.name/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exception.jaxws.webservices.javacode.name/", name = "DivisionByZeroException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exception.jaxws.webservices.javacode.name/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://exception.jaxws.webservices.javacode.name/", name = "divide")
