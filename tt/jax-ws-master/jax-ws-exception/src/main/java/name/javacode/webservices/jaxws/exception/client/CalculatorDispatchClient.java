package name.javacode.webservices.jaxws.exception.client;
...
import name.javacode.webservices.jaxws.exception.client.generated.Divide;
import name.javacode.webservices.jaxws.exception.client.generated.DivideResponse;
import name.javacode.webservices.jaxws.exception.client.generated.Multiply;
import name.javacode.webservices.jaxws.exception.client.generated.MultiplyResponse;
import name.javacode.webservices.jaxws.exception.client.generated.ObjectFactory;
...
public class CalculatorDispatchClient {
    ...
    private static final String NAMESPACE_URI = "http://exception.jaxws.webservices.javacode.name/";
	...
	JAXBContext jaxbCtx = JAXBContext
		.newInstance("name.javacode.webservices.jaxws.exception.client.generated");
