 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://exception.jaxws.webservices.javacode.name/", wsdlLocation = "http://localhost:8080/jax-ws-exception/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://exception.jaxws.webservices.javacode.name/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jax-ws-exception/CalculatorService?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://exception.jaxws.webservices.javacode.name/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://exception.jaxws.webservices.javacode.name/", "CalculatorPort"), Calculator.class, features);
    }
