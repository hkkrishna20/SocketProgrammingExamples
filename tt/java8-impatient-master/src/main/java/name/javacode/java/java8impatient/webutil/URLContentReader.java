...
import static name.javacode.java.java8impatient.webutil.SimpleHttpServer.PASSWORD;
import static name.javacode.java.java8impatient.webutil.SimpleHttpServer.USERNAME;
