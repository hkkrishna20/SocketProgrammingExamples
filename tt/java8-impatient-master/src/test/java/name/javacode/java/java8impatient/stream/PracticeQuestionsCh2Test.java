...
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.asCharacterStream;
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.average;
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.countShortWords;
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.filterAndCountShortWords;
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.infiniteRandomStream;
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.joinUsingFlatMap;
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.joinUsingReduce1;
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.joinUsingReduce2;
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.joinUsingReduce3;
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.lazy;
import static name.javacode.java.java8impatient.stream.PracticeQuestionsCh2.zip;
