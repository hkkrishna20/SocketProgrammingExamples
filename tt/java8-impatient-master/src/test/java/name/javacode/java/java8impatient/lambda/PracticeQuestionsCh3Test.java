package name.javacode.java.java8impatient.lambda;

import static java.nio.charset.StandardCharsets.UTF_8;
import static java.util.Arrays.asList;
import static name.javacode.java.java8impatient.lambda.PracticeQuestionsCh3.capitalize;
import static name.javacode.java.java8impatient.lambda.PracticeQuestionsCh3.doInParallelAsync;
import static name.javacode.java.java8impatient.lambda.PracticeQuestionsCh3.isLoggingEnabledFor;
import static name.javacode.java.java8impatient.lambda.PracticeQuestionsCh3.logIf;
import static name.javacode.java.java8impatient.lambda.PracticeQuestionsCh3.map;
import static name.javacode.java.java8impatient.lambda.PracticeQuestionsCh3.withLock;
