 ...
 * generated in the fi.vm.kapa.xml.rova.api.authorization package. 
...
public class ObjectFactory {
    ...
    private final static QName _RovaAuthorizationResponseExceptionMessage_QNAME = new QName("", "exceptionMessage");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fi.vm.kapa.xml.rova.api.authorization
     * 
     */
    ...
    /**
     * Create an instance of {@link RovaAuthorizationService }
     * 
     */
    public RovaAuthorizationService createRovaAuthorizationService() {
        return new RovaAuthorizationService();
    }
    ...
    /**
     * Create an instance of {@link RovaAuthorizationServiceResponse }
     * 
     */
    public RovaAuthorizationServiceResponse createRovaAuthorizationServiceResponse() {
        return new RovaAuthorizationServiceResponse();
    }

    /**
     * Create an instance of {@link RovaAuthorizationResponse }
     * 
     */
    public RovaAuthorizationResponse createRovaAuthorizationResponse() {
        return new RovaAuthorizationResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "exceptionMessage", scope = RovaAuthorizationResponse.class)
    public JAXBElement<String> createRovaAuthorizationResponseExceptionMessage(String value) {
        return new JAXBElement<String>(_RovaAuthorizationResponseExceptionMessage_QNAME, String.class, RovaAuthorizationResponse.class, value);
    }
