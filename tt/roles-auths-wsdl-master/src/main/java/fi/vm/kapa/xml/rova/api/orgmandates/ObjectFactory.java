 ...
 * generated in the fi.vm.kapa.xml.rova.api.orgmandates package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrgMandatesTypeIncomplete_QNAME = new QName("", "incomplete");
    private final static QName _ResponseExceptionMessage_QNAME = new QName("", "exceptionMessage");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fi.vm.kapa.xml.rova.api.orgmandates
     * 
     */
    ...
    /**
     * Create an instance of {@link RovaOrgMandatesServiceResponse }
     * 
     */
    public RovaOrgMandatesServiceResponse createRovaOrgMandatesServiceResponse() {
        return new RovaOrgMandatesServiceResponse();
    }
    ...
    /**
     * Create an instance of {@link RovaOrgMandatesService }
     * 
     */
    public RovaOrgMandatesService createRovaOrgMandatesService() {
        return new RovaOrgMandatesService();
    }

    /**
     * Create an instance of {@link OrgMandatesType }
     * 
     */
    public OrgMandatesType createOrgMandatesType() {
        return new OrgMandatesType();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "incomplete", scope = OrgMandatesType.class)
    public JAXBElement<Boolean> createOrgMandatesTypeIncomplete(Boolean value) {
        return new JAXBElement<Boolean>(_OrgMandatesTypeIncomplete_QNAME, Boolean.class, OrgMandatesType.class, value);
    }
