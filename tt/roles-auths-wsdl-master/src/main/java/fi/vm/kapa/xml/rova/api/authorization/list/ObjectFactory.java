 ...
 * generated in the fi.vm.kapa.xml.rova.api.authorization.list package. 
...
public class ObjectFactory {
    ...
    private final static QName _RovaAuthorizationListResponseExceptionMessage_QNAME = new QName("", "exceptionMessage");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fi.vm.kapa.xml.rova.api.authorization.list
     * 
     */
    ...
    /**
     * Create an instance of {@link RovaAuthorizationListServiceResponse }
     * 
     */
    public RovaAuthorizationListServiceResponse createRovaAuthorizationListServiceResponse() {
        return new RovaAuthorizationListServiceResponse();
    }
    ...
    /**
     * Create an instance of {@link RovaAuthorizationListResponse }
     * 
     */
    public RovaAuthorizationListResponse createRovaAuthorizationListResponse() {
        return new RovaAuthorizationListResponse();
    }

    /**
     * Create an instance of {@link RovaAuthorizationListService }
     * 
     */
    public RovaAuthorizationListService createRovaAuthorizationListService() {
        return new RovaAuthorizationListService();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "exceptionMessage", scope = RovaAuthorizationListResponse.class)
    public JAXBElement<String> createRovaAuthorizationListResponseExceptionMessage(String value) {
        return new JAXBElement<String>(_RovaAuthorizationListResponseExceptionMessage_QNAME, String.class, RovaAuthorizationListResponse.class, value);
    }
