package name.javacode.javaee.availability.domain;

import static java.time.format.DateTimeFormatter.ISO_LOCAL_DATE_TIME;

import java.time.LocalDateTime;

import name.javacode.javaee.availability.representation.SlotDateTimeDeserializer;
import name.javacode.javaee.availability.representation.SlotDateTimeSerializer;
