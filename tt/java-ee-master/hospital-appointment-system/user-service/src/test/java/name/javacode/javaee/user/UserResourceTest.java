package name.javacode.javaee.user;

import static java.util.stream.Collectors.toList;
import static javax.ws.rs.core.Response.Status.NOT_FOUND;
import static javax.ws.rs.core.Response.Status.OK;
import static name.javacode.javaee.user.domain.User.Type.Doctor;
import static name.javacode.javaee.user.domain.User.Type.Patient;
...
import name.javacode.javaee.user.service.UserService;
