...
public class UserPreferenceController {
	...
	HttpEntity<Resource<UserPreference>> findUserPreference(@PathVariable("name") String name,
			@PathVariable("serviceId") int serviceId) {
		Resource<UserPreference> userPreference = resourceAssembler.findUserPreference(name, serviceId);
	...
	HttpEntity<Resource<UserPreference>> createUserPreference(@PathVariable("name") String name,
			@PathVariable("serviceId") int serviceId, @RequestParam("value") String value) {
		Resource<UserPreference> userPreference = resourceAssembler.saveUserPreference(name, serviceId, value);
	...
	HttpEntity<Resource<UserPreference>> updateUserPreference(@PathVariable("name") String name,
			@PathVariable("serviceId") int serviceId, @RequestParam("value") String value) {
		Resource<UserPreference> userPreference = resourceAssembler.saveUserPreference(name, serviceId, value);
	...
	HttpEntity<Resource<UserPreference>> deleteUserPreference(@PathVariable("name") String name,
			@PathVariable("serviceId") int serviceId) {
