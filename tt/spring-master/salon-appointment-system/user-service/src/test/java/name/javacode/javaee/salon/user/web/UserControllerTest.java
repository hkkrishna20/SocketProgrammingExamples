package name.javacode.javaee.salon.user.web;

import static name.javacode.javaee.salon.domain.Role.ROLE_ANONYMOUS;
...
import name.javacode.javaee.salon.service.UserIdAwareUserDetails;
...
import name.javacode.javaee.salon.user.repository.AuthorityRepository;
import name.javacode.javaee.salon.user.repository.UserRepository;
