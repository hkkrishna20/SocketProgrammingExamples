		...
		<div class="err">
			<div>
				<h2 style="text-align: center;">
					Error 404. Oops The page you are looking for <b>Doesn't Exist</b>
				</h2>
			</div>
			<div align="center">
				<a href="landInLogin" class="btn btn-primary btn-lg"> <span
					class="glyphicon glyphicon-home"></span> Login
				</a>
			</div>
		</div>
	</div>
