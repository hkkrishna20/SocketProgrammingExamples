...
<body>
	<header>
		<nav
			...
			<a class="navbar-brand" href="home">Ranking<span>Enzymes</span></a>
			...
			<div class="collapse navbar-collapse justify-content-center"
				...
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link"
						href="metapage">Home <span class="sr-only">(current)</span></a></li>
					<li class="nav-item"><a class="nav-link" href="landInLogin">Login</a>
					</li>
					<li class="nav-item"><a class="nav-link" href="searchGenome">Browse
							Genomes </a></li>
					<li class="nav-item"><a class="nav-link"
						href="searchClassifier">Browse Enzymes </a></li>
					<li class="nav-item"><a class="nav-link"
						href="dashboardClassifier">List Enzymes</a></li>
					<li class="nav-item"><a class="nav-link" href="dashboardFungi">List
							Genomes</a></li>
	...
	<main
		style="margin-bottom:2% !important;padding-bottom: 2% !important; margin-top:1% ! important; padding-top: 1% !important; ">
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2 inner_div "
				align="left" style="padding-left: 2cm !important;"></div>
			<div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
				<div class="jumbotron-fluid">
					<h1 class="display-4">Hello, All!</h1>
					<p class="lead">Simple Application to provide ease of access to
						Enzymes and Genomes List.</p>
					<hr class="my-4">
					<p class="lead">
						<a class="btn btn-primary btn-lg" href="metapage" role="button">Learn
							more</a>
					</p>
				</div>
			</div>
	...
	<div class="container  container-fluid">
		<div class="row">
			<div class="col-sm-6">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Genome Code - Enzymes</h5>
						<a href="searchClassifier" class="btn btn-primary">Go</a>
					</div>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Classifier Ranking</h5>
						<a href="searchGenomes" class="btn btn-primary">Go</a>
					</div>
				</div>
			</div>
		</div>
