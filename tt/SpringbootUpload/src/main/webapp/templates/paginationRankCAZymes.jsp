...
body {
 background-image: linear-gradient(to right, #ff8177 0%, #ff867a 0%, #ff8c7f 21%, #f99185 52%, #cf556c 78%, #b12a5b 100%);	padding-top: 50px;
	font: 16px Arial;
}
		...
		<div class="row">
			<div class="col-md-12">
				...
				<form class="form-horizontal" id="searchCazymes-form"
					...
					action="searchCazymes" method="post">
					<div style="width: 300px;" class="autocomplete" role="menu">
						<div class="form-group">
							<label for="filter">Filter by</label> <select id="searchCriteria"
								name="searchCriteria" class="form-control">
								<option value="name" selected>Name</option>
								<option value="genomeCode">Genome Code</option>
								<option value="published">Published</option>
								<option value="assemblyLength">Assembly Length</option>
								<option value="genes">Genes</option>
							</select>
						</div>
						<div class="form-group">
							<label for="filter">Order By</label> <select id="searchCriteria"
