...
<body>
	...
	<div class="row" id="showData" align="center">
		<form>
			<input type="button" class=" btn btn-warning active btn-block"
				id="click" value="Click Me">
		</form>
	</div>
	<br />
	<div class="row">
		<div id="ajaxGetUserServletResponse"
			class="container container table-responsive  table-bordered table-striped table-condensed cf"
			style="position: relative !important; margin: auto;"></div>
		<!--container-->
	</div>

	<div class="row" style = "padding-top: 50px !important;  padding-right: 30px !important; padding-bottom: 200px  !important; padding-left: 80px !important;">
</div>
