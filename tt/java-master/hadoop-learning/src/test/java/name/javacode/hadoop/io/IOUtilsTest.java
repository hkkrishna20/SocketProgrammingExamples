...
import static name.javacode.hadoop.io.IOUtils.addExtension;
import static name.javacode.hadoop.io.IOUtils.compressFile;
import static name.javacode.hadoop.io.IOUtils.createMapFile;
import static name.javacode.hadoop.io.IOUtils.findInMapFile;
import static name.javacode.hadoop.io.IOUtils.removeExtension;
import static name.javacode.hadoop.io.IOUtils.uncompressFile;

import java.io.File;
import java.net.URI;

import name.javacode.hadoop.citation.CitationCombiner;
