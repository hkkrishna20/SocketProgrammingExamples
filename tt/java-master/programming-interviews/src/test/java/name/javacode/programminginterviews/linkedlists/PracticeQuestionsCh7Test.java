 ...
 *******************************************************************************/
package name.javacode.programminginterviews.linkedlists;

import static name.javacode.programminginterviews.linkedlists.PracticeQuestionsCh7.evenOddMerge;
import static name.javacode.programminginterviews.linkedlists.PracticeQuestionsCh7.intersection;
import static name.javacode.programminginterviews.linkedlists.PracticeQuestionsCh7.mergeLists;
import static name.javacode.programminginterviews.linkedlists.PracticeQuestionsCh7.startOfLoop;
import static name.javacode.programminginterviews.linkedlists.PracticeQuestionsCh7.reverse;

import java.util.Arrays;

import name.javacode.algorithms.core.datastructure.LinkedList;
import name.javacode.algorithms.core.datastructure.LinkedList.LinkedListNode;
