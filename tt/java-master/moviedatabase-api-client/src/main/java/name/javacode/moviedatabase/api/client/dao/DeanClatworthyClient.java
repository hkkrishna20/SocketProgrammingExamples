...
package name.javacode.moviedatabase.api.client.dao;

import java.util.Map;

import name.javacode.moviedatabase.api.client.ClientException;
import name.javacode.moviedatabase.api.client.domain.DeanClatworthyStyleMovie;
import name.javacode.moviedatabase.api.client.domain.Movie;
