...
public class Movie implements Serializable {
	...
	public Movie(String name, short year, String fileExtension) {
		this(name, year, UNKNOWN_GENRE, 0L, fileExtension);
	}

	public Movie(String name, short year, String genre, long filesize,
	...
	public boolean equals(Object obj) {
		...
		result = (name != null && name.equals(m.name));
		result &= (year == m.year);
		result &= (genre != null && genre.equals(m.genre));
