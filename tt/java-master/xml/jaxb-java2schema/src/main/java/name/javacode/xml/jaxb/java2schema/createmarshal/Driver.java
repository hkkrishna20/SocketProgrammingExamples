package name.javacode.xml.jaxb.java2schema.createmarshal;
...
import name.javacode.xml.jaxb.java2schema.createmarshal.cardfile.Address;
import name.javacode.xml.jaxb.java2schema.createmarshal.cardfile.BusinessCard;
